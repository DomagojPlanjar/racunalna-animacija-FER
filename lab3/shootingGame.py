...
BULLET_WIDTH, BULLET_HEIGHT = 15, 6

YELLOW_HIT = pygame.USEREVENT + 1
RED_HIT = pygame.USEREVENT + 2


YELLOW_SPACESHIP_IMAGE = pygame.image.load(os.path.join('Assets', 'space-ship.png'))
YELLOW_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(YELLOW_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 90)


RED_SPACESHIP_IMAGE = pygame.image.load(os.path.join('Assets', 'arcade-game.png'))
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    ...
    for bullet in red_bullets:
        ...
        #WIN.blit(bullet, (red.x + red.width, red.y + red.height//2 - 2))
...
def handle_bullets(yellow_bullets, red_bullets, yellow, red):
    ...
    for bullet_yellow in yellow_bullets:
        for bullet_red in red_bullets:
            if bullet_yellow.colliderect(bullet_red):
